...
* Customizing the menu
  ...
  :END:
  Please refer to the [[https://magit.vc/manual/transient/Modifying-Existing-Transients.html#Modifying-Existing-Transients][transient]] documentation for customizing the menu.
